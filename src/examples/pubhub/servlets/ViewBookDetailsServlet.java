 ...
 * Written By: Revature
 * 
 * Servlet implementation class for ViewBookDetailsServlet. This servlet class was included in the
 * Pubhub 100 starter base kit. I added a bit of code to retrieve some information from the database
 * to display alongside book details. This servlet will pull the tags for the selected book and
 * will check "true" for any tags found in the entirety of the DB to display to users what they can
 * select.
 * ================================================================================================
 */
...
public class ViewBookDetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Compares the tag lists and removes present tags from the list of all tags that will be read as unchecked by the JSP.
		// Probably not the best way of doing this. Should revisit.
