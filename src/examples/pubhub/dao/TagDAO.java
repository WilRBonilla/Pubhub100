 ...
 * 
 * TagDAO interface to add tags, remove tags, get all tags for one book, and get all books
 * with a given tag. This will help with SQL CRUD to CREATE, READ, UPDATE, DELETE records.
 * ================================================================================================
 */
