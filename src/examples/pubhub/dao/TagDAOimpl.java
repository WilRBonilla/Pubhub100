 ...
 * 
 * This class implements the methods established by the available TagDAO interface. Many of the
 * functionalities are derived from the BookDAO interface and its implementing class.
 * 
 * ================================================================================================
 */
public class TagDAOimpl implements TagDAO 
{
	...
	public List<Book> getAllBooks(String tag_name)
	{
		...
		try
		{
			 ...
			 *  This query joins the tables using ISBN_13 to only reveal any book titles for a given tag name. 
			 *  It does not show the ISBN or any other data.
			 */
	...
	/* ================================================================================================
	 * Update tag will change the name of a tag for all records with the old tag.
	 * Currently, the application does not use this method. when updating tags, it simply uses the
	 * add/remove tag methods above.
	 * ================================================================================================
	 */
	@Override
