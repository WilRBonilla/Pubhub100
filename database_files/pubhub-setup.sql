...
/*
 Create the book_tags table. We need a foreign key to reference books table.
 Additionally, this table has a composite key with its two columns to maintain
 normalization. It will also disallow multiples of the same tag to be added to 
 a specific book.
*/
